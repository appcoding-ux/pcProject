...
CREATE TABLE `member_role_set` (
  ...
  `role_set` tinyint DEFAULT NULL,
  KEY `FKnwvvi6k42nh9vj4aoep02u9jx` (`member_id`),
  CONSTRAINT `FKnwvvi6k42nh9vj4aoep02u9jx` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`),
  CONSTRAINT `member_role_set_chk_1` CHECK ((`role_set` between 0 and 1))
...
INSERT INTO `member_role_set` VALUES ('user2',0),('dodo607',0),('dodo6071',0),('myguor11',0),('admin',1);
